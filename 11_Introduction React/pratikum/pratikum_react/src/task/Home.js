...
import logoAlterra from "../asset/img/logo-ALTA@2x.png";
import fotoProfile from "../asset/img/matthew-hamilton-tNCH0sKSZbA-unsplash.jpg";
        ...
        <div>
            ...
            <div className="container">
                ...
                <div className="col-lg-8 col-md-12 col-sm-12 col-12">
                    ...
                    <a href="index.html"><img className="logo-atas" src={logoAlterra} alt="logo" /></a>
                    </div>
                </div>
            ...
            <div className="row align-items-center isi-home">
                <div className="col-lg-4 col-md-12 col-sm-12  col-12">
                <img id="foto-profil" src={fotoProfile} alt="foto" />
                </div>
                <div className="col-lg-8 col-md-12 col-sm-12 col-12">
